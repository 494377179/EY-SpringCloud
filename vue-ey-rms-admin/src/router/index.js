...
export const asyncRoutes = [
    ...
    children: [
      {
        path: 'index',
        name: 'Index',
        component: () => import('@/views/dashboard/rpaMonitor/index'),
        meta: {
          title: '首页',
          icon: 'home',
          affix: true,
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    name: 'Dashboard',
    meta: { title: '仪表盘', icon: 'tachometer-alt', permissions: ['admin'] },
    children: [
      {
        path: 'vmMonitor',
        name: 'VmMonitor',
        component: () =>
          import('@/views/dashboard/vmMonitor/index'),
        meta: { title: '虚拟机监控', permissions: ['admin'] },
      },
      {
        path: 'rpaMonitor',
        name: 'RpaMonitor',
        component: () =>
          import('@/views/dashboard/rpaMonitor/index'),
        meta: { title: '机器人监控', permissions: ['admin'] },
      },
      {
        path: 'jobMonitor',
        name: 'JobMonitor',
        component: () =>
          import('@/views/dashboard/jobMonitor/index'),
        //meta: { title: '任务监控', badge: 'New' },
        meta: { title: '任务监控', permissions: ['admin'] },
      },
      {
        path: 'mapMonitor',
        name: 'MapMonitor',
        component: () =>
          import('@/views/dashboard/mapMonitor/index'),
        //meta: { title: '区域监控', badge: 'New' },
        meta: { title: '区域监控', permissions: ['admin'] },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    name: '系统管理',
    meta: { title: '系统管理', icon: 'wrench', permissions: ['admin'] },
    children: [
      {
        path: 'userManagement',
        name: '用户管理',
