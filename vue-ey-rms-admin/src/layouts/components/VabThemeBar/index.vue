...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('vue-ey-rms-admin-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName(
          'body'
        )[0].className = `vue-ey-rms-admin-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`vue-ey-rms-admin-theme-${name}`)
        localStorage.removeItem('vue-ey-rms-admin-theme')
